      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            ...
            Tech Vaseegrah is committed to transforming small businesses into smart, efficient enterprises through innovative technology solutions. 
            We aim to streamline operations and drive sustainable growth, empowering entrepreneurs to thrive in the digital world.
            </p>
            <p className="text-lg text-gray-700">
            Our vision is to be a catalyst for digital transformation, fostering innovation and sustainability in businesses of all sizes. 
            We strive to create a future where smart technology enables businesses to thrive and succeed.
            </p>
            <motion.div
              initial={{ width: 0 }}
